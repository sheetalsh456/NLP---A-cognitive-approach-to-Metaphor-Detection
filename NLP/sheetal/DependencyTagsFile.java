...
class DependencyTagsFile {
   public static void main(String []args) throws Exception {
    ...
    int ans;
        ...
        //System.out.println("\n\nReln\tRelnLength\tGov\tGovLength\tDep\tDepLength");
        ...
        int govlength=typedDependency.gov().value().toString().length();
        int deplength=typedDependency.dep().value().toString().length();
        System.out.println((ans+500)+"\t"+relnlength+"\t"+typedDependency.gov().index()+"\t"+govlength+"\t"+typedDependency.dep().index()+"\t"+deplength); 
  }
  System.out.println("\n");
  sentence="";
}
